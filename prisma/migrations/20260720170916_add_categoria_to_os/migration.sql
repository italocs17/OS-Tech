...
INSERT INTO "new_ordem_servico" ("clienteId", "contatoId", "dataConclusao", "dataEntrada", "dataPrevisao", "desconto", "descontoTipo", "equipamentoId", "formaPagamento", "id", "numeroOS", "observacoes", "status", "tecnicoId", "tipoAtendimento") SELECT "clienteId", "contatoId", "dataConclusao", "dataEntrada", "dataPrevisao", "desconto", "descontoTipo", "equipamentoId", "formaPagamento", "id", "numeroOS", "observacoes", "status", "tecnicoId", "tipoAtendimento" FROM "ordem_servico";
