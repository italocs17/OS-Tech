...
CREATE TABLE "new_ordem_servico" (
    ...
    CONSTRAINT "ordem_servico_categoriaServicoId_fkey" FOREIGN KEY ("categoriaServicoId") REFERENCES "categoria_servico" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_ordem_servico" ("categoriaServicoId", "clienteId", "contatoId", "dataConclusao", "dataEntrada", "dataPrevisao", "desconto", "descontoTipo", "equipamentoId", "formaPagamento", "id", "numeroOS", "observacoes", "status", "tecnicoId", "tipoAtendimento") SELECT "categoriaServicoId", "clienteId", "contatoId", "dataConclusao", "dataEntrada", "dataPrevisao", "desconto", "descontoTipo", "equipamentoId", "formaPagamento", "id", "numeroOS", "observacoes", "status", "tecnicoId", "tipoAtendimento" FROM "ordem_servico";
...
CREATE INDEX "ordem_servico_categoriaServicoId_idx" ON "ordem_servico"("categoriaServicoId");
CREATE INDEX "ordem_servico_status_idx" ON "ordem_servico"("status");
CREATE INDEX "ordem_servico_statusLogistico_idx" ON "ordem_servico"("statusLogistico");
